...
import os
os.system("sudo apt install openvpn dialog python3-pip python3-setuptools git spotify vlc steam minecraft gimp chromium ffmpeg obs-studio gnome-software kdenlive wget openjdk-8-jre
