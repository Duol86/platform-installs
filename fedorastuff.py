...
os.system("sudo dnf install discord xorg-xll-drv-nvidia-cuda spotify vlc steam lutris gimp chromium git openvpn dialog python3-pip python3-setuptools gnome-software kdenlive wine-stable wget")
